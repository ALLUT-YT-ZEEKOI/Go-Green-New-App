...
class OpenSub extends StatelessWidget {
  const OpenSub({super.key});
  @override
  Widget build(BuildContext context) {
        ...
        builder: (BuildContext context) => BackdropFilter(
          ...
          child: AlertDialog(
            ...
            content: const Padding(
              ...
              child: Text(
                "After cancellation, access to this subscription is no longer available",
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      if (open != null) {
                        ...
                        apiProvider.cancelSubscription(open);
                        Navigator.pop(context);
                      }
                    },
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Row(
            mainAxisAlignment: MainAxisAlignment.start, children: [Text('Subscription', style: TextStyle(color: Color(0xFF1D2730), fontSize: 16, fontFamily: 'Poppins', fontWeight: FontWeight.w500))]),
            ...
            : ListView(
                children: [
                          ...
                          children: [
                            ...
                            SizedBox(
                              child: Row(
                                ...
                                children: [
                                  const Text('Qty : ', textScaler: TextScaler.noScaling, style: TextStyle(color: Color(0xFF909090), fontSize: 16, fontFamily: 'Poppins', fontWeight: FontWeight.w400)),
                                  Text('${open.qty}',
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (open.coupon!.type != 'subscription')
                                      Text('valid till: ${formatDate(open.coupon!.endDate)}',
                                          style: const TextStyle(color: Colors.red, fontSize: 9, fontFamily: 'Poppins', fontWeight: FontWeight.w400))
                                  ],
                                ),
                              ),
                            ...
                            Row(
                              children: [
                                Container(
                                    ...
                                    decoration: BoxDecoration(border: Border.all(width: 1, color: const Color(0xFF2F9623)), borderRadius: BorderRadius.circular(5.90), color: const Color(0xFFEFFFED)),
                                    child: Center(
                  ...
                  Container(
                    ...
                    width: size.width,
                    height: 50,
                    decoration: BoxDecoration(color: const Color(0xFFE10F24), borderRadius: BorderRadius.circular(15)),
                    child: MaterialButton(
                      onPressed: () => cancel(),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                      child:
                          const Text('Cancel Subscription', textScaler: TextScaler.noScaling, style: TextStyle(color: Colors.white, fontSize: 15, fontFamily: 'Poppins', fontWeight: FontWeight.w500)),
                    ),
                  )
                ],
              ),
