...
bool islogin = false;
bool isuser = false;
const AndroidNotificationChannel channel = AndroidNotificationChannel('test', 'test notification', playSound: true);
...
class SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    Timer(const Duration(milliseconds: 2800), () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => CheckPage(islogin: islogin, isuser: isuser))));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(gradient: LinearGradient(begin: Alignment(0.65, -0.76), end: Alignment(-0.65, 0.76), colors: [Color(0xFFF9EEDB), Color(0xFFFEFEFC)])),
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (notification != null && androidNotification != null) {
        flutterLocalNotificationsPlugin.show(notification.hashCode, notification.title, notification.body,
            NotificationDetails(android: AndroidNotificationDetails(channel.id, channel.name, priority: Priority.max, icon: 'launch_background')));
      }
    });
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      AndroidNotification? androidNotification = message.notification?.android;
      if (notification != null && androidNotification != null) {
        showDialog(context: context, builder: (_) => AlertDialog(title: Text(notification.title!), content: SingleChildScrollView(child: Column(children: [Text(notification.body!)]))));
      }
    });
  }
    ...
    return MultiProvider(
        ...
        child: GetMaterialApp(
            ...
            theme: ThemeData(
                ...
                colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.blue).copyWith(secondary: const Color.fromRGBO(109, 107, 110, 1))),
