              ...
              children: [
                    ...
                    children: [
                      ...
                      if (!distanceInMeters(lat: mainProvider.lat!.latitude, long: mainProvider.lat!.logitude))
                        Container(
                          ...
                          width: size.width,
                          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(18), boxShadow: const [BoxShadow(color: Color(0x14000000), blurRadius: 4)]),
                          child: const Padding(
                        ...
                        child: IntrinsicHeight(
                          child: Column(
                            ...
                            children: [
                              ...
                              Flexible(child: TextField(decoration: const InputDecoration(border: InputBorder.none), maxLines: null, controller: landmark, style: const TextStyle(fontSize: 13))),
                              Container(height: 1.2, margin: const EdgeInsets.only(bottom: 10), color: const Color(0x111D2730)),
                              ...
                              Flexible(child: TextField(decoration: const InputDecoration(border: InputBorder.none), maxLines: null, controller: address2, style: const TextStyle(fontSize: 13))),
                ...
                !show || (!distanceInMeters(lat: mainProvider.lat!.latitude, long: mainProvider.lat!.logitude))
                    ? Container(
                        ...
                        decoration: BoxDecoration(color: const Color(0xFFE9CDBE), borderRadius: BorderRadius.circular(8)),
                    ...
                    : Container(
                        ...
                        width: size.width,
                        margin: const EdgeInsets.only(bottom: 30),
                        decoration: BoxDecoration(color: const Color(0xFFF28B51), borderRadius: BorderRadius.circular(8)),
