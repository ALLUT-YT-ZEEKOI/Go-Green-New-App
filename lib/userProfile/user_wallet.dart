          ...
          children: [
                  ...
                  Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Column(
                        ...
                        children: [const Text('Wallet balance', style: walletLabel), if (apiProvider.userDetails != null) Text('₹ ${apiProvider.userDetails!.balance}', style: walletValue)],
                      ),
                      apiProvider.walletReload ? const CircularProgressIndicator() : Image.asset('assets/icons/wallet-1.png', height: 40)
                    ]),
                  ),
                            ...
                            for (var i = 0; i < preamount.length; i++)
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(width: 0.78, color: i == preCount ? const Color(0xFFFD995B) : const Color(0x111D2730)), borderRadius: BorderRadius.circular(36.51)),
                                child: MaterialButton(
                                    padding: EdgeInsets.zero,
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(36)),
                                    onPressed: () => updateIndex(i),
                                    child: Center(child: Text('₹${preamount[i]}', style: const TextStyle(color: Color(0xFF909090), fontSize: 10, fontFamily: 'Poppins', fontWeight: FontWeight.w500)))),
                              )
                          ],
                        )
                      ],
            ...
            Container(
              ...
              child: MaterialButton(
                  ...
                  child: const Text('Add Money', style: TextStyle(color: Colors.white, fontSize: 15, fontFamily: 'Poppins', fontWeight: FontWeight.w500))),
            )
          ],
        ),
      ),
