...
class SampleConformed extends StatelessWidget {
  const SampleConformed({super.key});
                      ...
                      children: [
                        ...
                        Text.rich(
                          TextSpan(
                            children: [
                              const TextSpan(
                                  text: 'Your order for sample milk is confirmed \nand it starts to deliver on ',
                                  style: TextStyle(color: Color(0xFF232323), fontSize: 10, fontFamily: 'Poppins', fontWeight: FontWeight.w500)),
