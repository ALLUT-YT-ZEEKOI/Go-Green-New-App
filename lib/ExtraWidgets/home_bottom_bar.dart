...
class HomeButtons extends StatelessWidget {
  const HomeButtons({super.key, required this.icon, required this.label, required this.index, required this.ontap});
  final String icon;
  final String label;
  final int index;
    ...
    return InkWell(
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Image.asset(icon, height: 30, color: mainProvider.homepageIndex == index ? Colors.green : null),
            Text(label, textScaler: TextScaler.noScaling, style: const TextStyle(color: Colors.white, fontSize: 9, fontFamily: 'Poppins', fontWeight: FontWeight.w400))
          ],
        ),
      ),
    );
