...
import 'carosel_calnder_header.dart';
...
/// [day] - day being built.
typedef DayBuilder = Widget? Function(bool isSelectable, int index, bool isSelectedDay, bool isToday, bool isPrevMonthDay, TextStyle textStyle, bool isNextMonthDay, bool isThisMonthDay, DateTime day);
...
class CalendarCarousel<T extends EventInterface> extends StatefulWidget {
  ...
  const CalendarCarousel({
    ...
    this.selectedDayBorderColor = const Color(0xFF0094FF),
    this.selectedDayButtonColor = const Color(0xFF0094FF),
...
class _CalendarState<T extends EventInterface> extends State<CalendarCarousel<T>> {
      ...
      child: Column(
        children: <Widget>[
          ...
          Expanded(
            ...
            physics: widget.isScrollable ? widget.pageScrollPhysics : const NeverScrollableScrollPhysics(),
  ...
  Widget renderDay(
    ...
    return Container(
      width: 31.20,
      height: 31.20,
      decoration: isSelectedDay || isToday
          ? BoxDecoration(
              borderRadius: BorderRadius.circular(13.26),
              boxShadow: const [
                BoxShadow(
                  color: Color(0x24695f97),
                  blurRadius: 11.31,
              ...
              child: Padding(
                ...
                child: GridView.count(
                  ...
                  children: List.generate(totalItemCount,
                    ...
                    bool isSelectedDay = selectedDateTime != null && selectedDateTime.year == year && selectedDateTime.month == month && selectedDateTime.day == index + 1 - _startWeekday;
              ...
              child: SizedBox(
                ...
                child: GridView.count(
                  ...
                  children: List.generate(weekDays.length, (index) {
                    ...
                    bool isSelectedDay = this._selectedDate.year == weekDays[index].year && this._selectedDate.month == weekDays[index].month && this._selectedDate.day == weekDays[index].day;
...
//            : DateTime.now();
  ...
  void _setDate([int page = -1]) {
    if (page == -1) {
      ...
      if (widget.weekFormat) {
        ...
        _controller.animateToPage(page, duration: const Duration(milliseconds: 1), curve: const Threshold(0.0));
      } else {
        setState(() {
          this._pageNum = page;
      ...
      if (onCalendarChanged != null) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          onCalendarChanged(!widget.weekFormat ? this._dates[page] : this._weeks[page][firstDayOfWeek]);
        });
      }
    }
  }
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: markedDateMoreCustomTextStyle ?? const TextStyle(fontSize: 9.0, color: Colors.white, fontWeight: FontWeight.normal),
                    ),
                  ),
                ),
              ),
  ...
  TextStyle? getDayStyle(
      bool isSelectable, int index, bool isSelectedDay, bool isToday, bool isPrevMonthDay, TextStyle? textStyle, TextStyle defaultTextStyle, bool isNextMonthDay, bool isThisMonthDay, DateTime now) {
